...
Процедура ОтобразитьДоску()
	...
	|	Центр_НастройкиПользователейКолонокКанБан.НастройкиКолонки КАК НастройкиКолонки,
	|	Центр_НастройкиПользователейКолонокКанБан.Наименование КАК Наименование,
	|	Центр_Цвета.ЦветRGB КАК ЦветRGB,
	|	Центр_НастройкиПользователейКолонокКанБан.Цвет КАК Цвет
	|ИЗ
	|	РегистрСведений.Центр_НастройкиПользователейКолонокКанБан КАК Центр_НастройкиПользователейКолонокКанБан
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Центр_Цвета КАК Центр_Цвета
	|		ПО Центр_НастройкиПользователейКолонокКанБан.Цвет = Центр_Цвета.Ссылка
	|ГДЕ
	...
	ТекстЗапросаДС = "ВЫБРАТЬ
	                 ...
	                 |	Центр_Задача.Дата КАК Дата,
	                 |	Центр_Задача.Номер КАК Номер,
	                 |	Центр_Задача.Ссылка КАК Ссылка,
	                 |	Центр_Задача.Наименование КАК Наименование,
	                 |	Центр_Задача.ОписаниеЗадачи КАК ОписаниеЗадачи,
	                 |	Центр_Задача.ВидЗадачи КАК ВидЗадачи,
	                 |	Центр_Задача.Постановщик КАК Постановщик,
	                 |	Центр_Задача.Приоритет КАК Приоритет,
	                 |	Центр_Задача.Автор КАК Автор,
	                 |	Центр_Задача.ГлавнаяЗадача КАК ГлавнаяЗадача,
	                 |	Центр_Задача.УчетВремени КАК УчетВремени,
	                 |	Центр_Задача.КонтрольВремени КАК КонтрольВремени,
	                 ...
	                 |		Метка КАК Метка
	                 |	) КАК Метки,
	                 |	Центр_Задача.МоментВремени КАК МоментВремени,
	                 |	Центр_Задача.Представление КАК Представление,
	                 ...
	                 |	Центр_ДедлайнЗадачСрезПоследних.Дедлайн КАК Дедлайн,
	                 ...
	                 |	Центр_ОценкаЧасовСрезПоследних.От КАК От,
	                 |	Центр_ОценкаЧасовСрезПоследних.До КАК До,
	                 |	Центр_ОценкаЧасовСрезПоследних.Длительность КАК Длительность,
	                 |	Центр_ОценкаЧасовСрезПоследних.Согласовано КАК Согласовано,
	                 |	Центр_ОценкаЧасовСрезПоследних.Отказ КАК Отказ,
	                 |	Центр_ОценкаЧасовСрезПоследних.Согласующий КАК Согласующий,
	                 |	Центр_ОценкаЧасовСрезПоследних.Согласовант КАК Согласовант,
	                 |	Центр_ОценкаЧасовСрезПоследних.ТипОценки КАК ТипОценки,
	                 |	Центр_ОценкаЧасовСрезПоследних.КомментарийОтказа КАК КомментарийОтказа,
	                 |	Центр_ОценкаЧасовСрезПоследних.КомментарийОценки КАК КомментарийОценки,
	                 |	"""" КАК Пустая
	                 |ИЗ
