...
Процедура ОткрытьПолнуюФорму(Команда)
	...
	ПараметрыФормы = Новый Структура("НаименованиеЗадачи,МеткиЗадачи,ГлавнаяЗадача,ИсточникПараметров",
		Объект.Наименование, МассивМеток, Объект.ГлавнаяЗадача, ИсточникПараметров);
