...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЕсли;
	//@skip-check unknown-form-parameter-access
	Если Параметры.Свойство("УчетВремени") Тогда
		Если ЗначениеЗаполнено(Параметры.УчетВремени) Тогда
			УчетВремени = Параметры.УчетВремени;
		КонецЕсли;
	КонецЕсли;
	...
	//@skip-check unknown-form-parameter-access
		Если Параметры.Свойство("Длительность") Тогда
			...
			КонецЕсли;
		КонецЕсли;
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "Длительность", "Видимость", Истина);
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "Длительность", "Видимость", Ложь);
	КонецЕсли;
КонецПроцедуры
